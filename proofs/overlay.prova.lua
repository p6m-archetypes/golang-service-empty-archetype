--- The p6m overlay standards (E1–E7), held against the Go "empty" archetype — a platform
...
local VARIANTS = {
  ...
  },
  {
    ...
    runtime_artifact = "bin/legacy-daemon",
  },
}
...
prova.group("golang-empty: the archetype itself", { tags = { "standards" } }, function(g)

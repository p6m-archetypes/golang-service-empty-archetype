-- Go Service Platform Overlay ("empty" archetype).
--
...
--
--   archetect render .../golang-service-empty-archetype /path/to/existing-project
--
...
-- No Go module_path prompt: nothing the overlay renders (CI, Dockerfiles,
-- Tiltfile, platform manifests) references it, so prompting would be noise.
